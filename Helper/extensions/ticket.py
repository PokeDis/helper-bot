...
class TicketCloseView(discord.ui.View):
    ...
    async def reopen_ticket(
        ...
        embed = discord.Embed(
            description=
            f"<:tick:1001136782508826777> The ticket has been re-opened by {interaction.user.mention}.\n\n"
...
class InsideTicketView(discord.ui.View):
    ...
    async def close_ticket(
        ...
        embed = discord.Embed(
            description=
            f"<:tick:1001136782508826777> The ticket has been closed by {interaction.user.mention}.\n\n"
...
class Ticket(commands.Cog, description="Reaction ticket system to provide support & help!\n`<input>` are mandatory and `[input]` are optional."):
    ...
    async def export(
        ...
        embed = discord.Embed(
            description="<:tick:1001136782508826777> Done!",
            color=discord.Color.green()
        )
    ...
    async def _ticket(
        ...
        community_helpers = ctx.guild.get_role(998284527908683806)
        if community_helpers:
            await channel.set_permissions(
                community_helpers, read_messages=True, send_messages=True
            )
    ...
    async def setup(self, ctx: commands.Context):
        ...
        if create_channel:
            embed = discord.Embed(
                description=
                "<:no:1001136828738453514> You already seem to have an active setup.\n"
        ...
        create_channel = await ticket_category.create_text_channel(
            "create-ticket"
        )
        ...
        embed = discord.Embed(
            ...
            description=
            "<:bullet:1014583675184230511> Opening tickets without reason will result in penalties.\n"
